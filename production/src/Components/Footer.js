                        ...
                        <li  class="slds-col cell">
                            <a  href="https://linkedin.com/company/microstrategy" class="icon linkedin">
                                <svg  xmlns="http://www.w3.org/2000/svg" version="1.1" width="16" height="16" viewBox="0 0 32 32">
                                    ...
                                    <path  fill="#000" d="M17.2 14.45v0c0-0.050 0-0.050 0 0v0zM31.9 29.7v-27.4c0-1.25-1.050-2.3-2.35-2.3h-27.1c-1.3 0-2.35 1.050-2.35 2.3v27.4c0 1.25 1.050 2.3 2.35 2.3h27.1c1.3 0 2.35-1.050 2.35-2.3zM9.75 26.8h-4.8v-14.45h4.8v14.45zM7.35 10.35v0c-1.65 0-2.7-1.1-2.7-2.5s1.050-2.5 2.7-2.5c1.65 0 2.65 1.1 2.7 2.5 0 1.4-1.050 2.5-2.7 2.5zM27.050 26.8h-4.8v-7.75c0-1.95-0.7-3.25-2.45-3.25-1.35 0-2.1 0.9-2.45 1.75-0.15 0.3-0.15 0.75-0.15 1.15v8.050h-4.8c0 0 0.050-13.1 0-14.45h4.8v2.050c0.65-1 1.8-2.4 4.35-2.4 3.15 0 5.55 2.050 5.55 6.5v8.35z"></path>
                                </svg>
                            </a>
                        </li>
                        <li  class="slds-col cell btn slim black">
                            <a  href="https://www.microstrategy.com/en/company/contact-us?now=start">Contact us</a>
                        </li>
                    </ul>
                    </nav>
                </div>
